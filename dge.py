...
if not st.session_state["dge_done"] and "metadata" in st.session_state:
    st.markdown("*To run the analysis, please select the parameters in the sidebar and click the 'Run DGE Analysis' button.*")
